...
<body style = 'text-align: center; margin-top:15%'>
	...
	<p style = 'font-weight: bold;'>Look’s like you’re really on the ball. <?php echo $poRecord->tranId ?> </br> has already been confirmed on <?php echo substr($confirmedBy, strpos($confirmedBy, ' on') + 3); ?>.</p>
