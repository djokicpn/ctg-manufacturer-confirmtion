    ...
    <script>
      $(document).ready(function () {
        ...
        $('#confirm-modal').click(function() {
          $('#confirm-modal').text('Please wait...');
          $('#confirm-modal').attr('disabled','disabled');
          sendData()
            ...
            success: function (data) {
              swal({
                  ...
                  buttons: false,
                    ...
                    window.location = "thanks.php?po=" + $('#poNumber').text();
                  })
      ...
      <div class="row h-100 justify-content-center align-items-center">
        <div class="box">
          ...
          <p>
            ...
            <span><b id='poNumber'><? echo $poRecord->tranId; ?></b></span>
            sent <span><b id="date_approved"><? echo date("j-M-Y", strtotime(substr($poRecord->createdDate, 0, strpos($poRecord->createdDate, 'T'))));?></b></span> has been
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr>
                <td>Pick up date:</td>
                <td class='old-value'><? echo $custbody_pick_up_system; ?></td>
                <td style='white-space:nowrap' class="buttons">
              ...
              <tr>
                <td>Shipment Type:</td>
                <td class='old-value'><? echo $custbodylist_shipment_type->name; ?></td>
                <td class="buttons">
                  <button class="btn btn-sm myButton confirmButton">
                    Confirm
                  </button>
              ...
              <tr>
                <td>Pallet Count:</td>
                <td class='old-value'><? echo $custbody_number_of_pallets; ?></td>
                <td class="buttons">
                  <button class="btn btn-sm myButton confirmButton">
                    Confirm
                  </button>
              ...
              <tr>
                <td>Produced For:</td>
                <td><? echo $custbody_stickeredfor->name; ?></td>
                <td>
              ...
              <tr>
                ...
                <td style="width:55%" class='old-value'><? echo $custbody_pickuplocation; ?></td>
                <td class="buttons">
                  <button class="btn btn-sm myButton confirmButton">
                    Confirm
                  </button>
              ...
              <tr>
                ...
                <td class='old-value'><? echo $custbody_pomessagefromproforma; ?></td>
                <td class="buttons">
                  <button class="btn btn-sm myButton confirmButton">
                    Confirm
                  </button>
